...
call s:h("Error", { "fg": s:red, "gui": "bold", "cterm": "bold" }) " any erroneous construct
call s:h("Todo", { "fg": s:purple, "gui": "bold", "cterm": "bold" }) " anything that needs extra attention; mostly the keywords TODO FIXME and XXX
...
call s:h("CursorLineNr", { "gui": "bold", "cterm": "bold" }) " Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
call s:h("MatchParen", { "fg": s:blue, "gui": "bold", "cterm": "bold" }) " The character under the cursor or just before it, if it is a paired bracket, and its match.
...
call s:h("WarningMsg", { "fg": s:yellow, "gui": "underline", "cterm": "underline" }) " warning messages
